...
void main() {
  group('PaginatedProductList Widget Tests (skipped in CI)', () {
    // These UI integration tests are intentionally skipped in CI due to
    // known layout differences in the test environment. Core pagination
    // logic is covered in unit tests.
    ...
    testWidgets('displays loading indicator on initial load',
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: MaterialApp(
            home: Scaffold(
              body: PaginatedProductList(onProductTap: (_) {}),
            ),
          ),
        ),
      );
    ...
    testWidgets('displays product list after loading', (WidgetTester tester) async {
      final mockRepo = MockPaginationRepository();
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [productRepositoryProvider.overrideWithValue(mockRepo)],
          child: MaterialApp(
            home: Scaffold(body: PaginatedProductList(onProductTap: (_) {})),
          ),
        ),
      );
    ...
    testWidgets('shows empty state when no products available', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: MaterialApp(
            home: Scaffold(
              body: PaginatedProductList(onProductTap: (_) {}, customEmptyWidget: const Text('No products')),
            ),
          ),
        ),
      );
  ...
  group('Pagination Controls Widget Tests (skipped in CI)', () {
    testWidgets('PaginationLoadingIndicator displays correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        ProviderScope(
          child: MaterialApp(
            home: Scaffold(body: PaginationLoadingIndicator(message: 'Loading...', showCancelButton: true)),
          ),
        ),
      );
